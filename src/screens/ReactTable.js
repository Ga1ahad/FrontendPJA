                            ...
                            {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                                return (
                                    <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                                        ...
                                        <TableCell>
                                            <IconButton aria-label="delete" color="secondary" className="tool" onClick={() =>
                                                console.log('http://localhost:59131/api' + '/' + siteName.toLowerCase() + '/' + rows)
                                                //axios.delete('http://localhost:59131/api' + '/' + siteName.toLowerCase() + '/' + columns.id)
                                            }>
                                                <DeleteIcon />
                                            </IconButton>
